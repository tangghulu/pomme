              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5">
                    ...
                    {r.isYou && (
                      <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-md bg-celery/30 text-primary">
                        you
                      </span>
                    )}
                  </div>
        ...
        {showManage && (
          <div className="mb-5">
            ...
            <div className="rounded-2xl border border-border bg-card overflow-hidden">
              ...
              <ManageRow icon={<Settings className="w-4 h-4" />} label="Manage invites" border />
...
function ManageRow({
  ...
  return (
    <button
      className={cn(
        "w-full flex items-center justify-between px-4 py-3.5 hover:bg-accent/30 transition-colors",
